 ...
 */
export const getQuery = ({ args = {}, model, role = '' }) => {
 ...
 * @return {Array} err 错误, query 结果对象
 */
export const getOption = ({ args = {}, model, role = '' }) => {
 ...
 * @return {Array} err 错误, query 结果对象
 */
export const getUpdateQuery = ({ args = {}, model, role = '' }) => {
 ...
 * @return {Array} err 错误, query 结果对象
 */
export const getUpdateContent = ({ args = {}, model, role = '' }) => {
 ...
 * @return {Array} err 错误, query 结果对象
 */
export const getSaveFields = ({ args = {}, model, role = '' }) => {
 ...
 * @return {String}
 */
export const getQuerySchema = (model) => {
 ...
 * @return {String}
 */
export const getUpdateSchema = (model) => {
 ...
 * @return {String}
 */
export const getSaveSchema = (model) => {
