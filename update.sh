...
# 登陆的服务器
SERVER='root@115.29.206.217'

# 项目端口号
PM2_NAME="api.xiaoduyu.com:9002"

# 项目在服务器的路径地址
SERVER_DIR="/home/wwwroot/api.xiaoduyu.com:9002"
